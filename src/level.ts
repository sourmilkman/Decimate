...
export const levels:LevelConfig[] = [
  ...
  },
  {
    ...
    objects:[
      ...
      {id:'bike',name:'Mountain Bike',position:[4.3,1.15,-.7],size:[2.5,2.1,.65],color:0x4e96b9,points:125,breakThreshold:27},
      {id:'shelves',name:'Storage Shelves',position:[-5,2,-1],size:[1.6,4,1.2],color:0x5b6263,points:145,breakThreshold:36},
      {id:'mower',name:'Lawn Mower',position:[1.4,.65,1.5],size:[1.7,1.2,1.5],color:0x72a04c,points:110,breakThreshold:25},
      {id:'tires',name:'Tire Stack',position:[-2.9,.95,1.9],size:[1.35,1.9,1.35],color:0x252728,points:95,breakThreshold:22,copyable:true,shape:'sphere'},
      {id:'crate1',name:'Storage Crate',position:[-.7,.55,-1],size:[1.5,1.1,1.25],color:0xd09b48,points:65,breakThreshold:14,copyable:true},
      {id:'crate2',name:'Storage Crate',position:[1,.55,-1],size:[1.5,1.1,1.25],color:0x4e8a78,points:65,breakThreshold:14,copyable:true},
